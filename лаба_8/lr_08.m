...
while DATA==0
 ...
 b = [0.5+0.02*Nb, (0.5+0.02*Nb)*(-1)^(Nb+1)*(0.9822+0.0178*Nb), (0.5+0.02*Nb)*(0.8+0.2*mod(Nb,5))];     % бейрнп йнщттхжхемрнб вхякхрекъ оепедюрнвмни тсмйжхх
 a = [1, (-1)^Nb*(0.7778+0.025*Nb), 0.64+0.006*Nb];     % бейрнп йнщттхжхемрнб гмюлемюрекъ оепедюрнвмни тсмйжхх
